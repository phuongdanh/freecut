...
import { useAuth } from '@/features/projects/deps/auth-contract';
...
import { Plus, Upload, FolderOpen, File, LogOut, User } from 'lucide-react';
...
import type { ImportProgress } from '@/features/projects/deps/project-bundle-contract';
import { BUNDLE_EXTENSION, loadBundleImportService } from '@/features/projects/deps/project-bundle-contract';
...
export function ProjectsPage() {
  ...
  const handleStartImport = async () => {
    ...
    try {
      ...
      const { importProjectBundle } = await loadBundleImportService();
        ...
        <div className="panel-header border-b border-border">
          <div className="max-w-[1920px] mx-auto px-6 py-5 flex items-center justify-between gap-4">
            ...
            <div className="flex min-w-0 flex-1 items-center justify-end gap-3">
              <Button variant="outline" size="lg" className="gap-2 shrink-0" onClick={handleImportClick}>
          ...
          {/* Hidden file input for import (outside flex row) */}
          <input
            ref={fileInputRef}
            type="file"
            accept=".zip"
